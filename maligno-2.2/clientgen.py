...
if __name__ == '__main__':
    ...
    if standalone:
        ...
        for msfpayload in payload_config:
            ...
            while not payload_generated:
                try:
                    ...
                    client_code = libs.malcli.generate_client_code(server_config, profile_request_config, profile_response_config, profile_network_config, profile_client_config, profile_client_header_config, client_template, msfpayload, package, standalone)
        ...
        for msfpayload in payload_config:
            ...
            libs.malout.print_info("Generating client code...")
            client_code = libs.malcli.generate_client_code(server_config, profile_request_config, profile_response_config, profile_network_config, profile_client_config, profile_client_header_config, client_template, msfpayload, None, standalone)
