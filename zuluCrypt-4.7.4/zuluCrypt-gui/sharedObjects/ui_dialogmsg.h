...
public:
    ...
    void setupUi(QDialog *DialogMsg)
    {
        ...
        labelType->setGeometry(QRect(0, 20, 381, 21));
        ...
        labelCipher->setGeometry(QRect(0, 40, 381, 21));
        ...
        labelKeySize->setGeometry(QRect(0, 60, 381, 21));
        ...
        labelUnused->setGeometry(QRect(0, 260, 381, 20));
        ...
        labelUsedPerc->setGeometry(QRect(0, 280, 381, 20));
        ...
        labelActiveSlots->setGeometry(QRect(0, 180, 381, 20));
