...
public:
    ...
    void setupUi(QDialog *luksdeletekey)
    {
        ...
        luksdeletekey->setAcceptDrops(true);
        ...
        pushButtonOpenVolume->setAutoDefault(true);
        ...
        pushButtonOpenPartition->setAutoDefault(true);
